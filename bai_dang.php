...
if(isset($_GET['search'])){
    ...
    $sql_bai_dang = "select * from bai_dang where ma_bai_dang = $ma_bai_dang";
}
$array_bai_dang = mysqli_query($connect,$sql_bai_dang);
$count = mysqli_num_rows($array_bai_dang);
?>
<!DOCTYPE html>
<html lang="vi">
    <head>
    ...
    <div class="container-fluid body">   
        <div class="row">
            ...
            <div class="col-md-7 px-0 pb-5 bodycenter"> 
                ...
                <?php if ($search == ''): ?>
                    <a class="ml-5 mt-4 mr-5 pl-5 pr-5 nav-link tieudebaidang" href="Toyota.php">TOYOTA CAMRY 2015</a>
                <?php endif ?>
                ...
                <div class="ml-5 mt-2 mr-5 pl-5 pr-5">
                    <?php if (isset($_GET['ma_bai_dang'])): ?>
                        <h2 class="pl-0 mt-5 tieudebaidang display-5"><?php echo $each['tieu_de'] ?>
                    <?php endif ?>
                    <?php if (isset($_GET['search'])): ?>
                        <a class="nav-link pl-0 tieudebaidang text-hover display-5" href="bai_dang.php?ma_bai_dang=<?php echo $each['ma_bai_dang'] ?>"><h2 class="mt-5 mb-0"><?php echo $each['tieu_de'] ?></h2></a>
                    <?php endif ?>
                    </h2>
                    <p class="mt-3"><?php echo $each['tom_tat'] ?></p>
                    <?php if(isset($_GET['ma_bai_dang'])): ?>
                        <?php if ($each['anh'] != NULL): ?>
                            <div class="text-center"><img class=" img-fluid my-2 px-5" src="anh/<?php echo $each['anh'] ?>"></div>
                        <p class="my-2"><?php echo $each['noi_dung'] ?></p>
                        <?php endif ?>
                    <?php endif ?>
                    <?php if(isset($_GET['search'])): ?>
